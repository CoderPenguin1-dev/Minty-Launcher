...
# Downloading
You can get prebuilt, Framework-Dependant Win86 bins from the [Google Drive](https://drive.google.com/drive/folders/1WFhlLlC_Ka0N-Fk6tTlCKcxksYwFRNg4?usp=sharing), as well as a premade port database file and the user manual.

You can also get Win64 bins (both Framework-Dependant and Standalone) as well as the premade port database file here on the repo. I'll give Win86 bins here eventually.
